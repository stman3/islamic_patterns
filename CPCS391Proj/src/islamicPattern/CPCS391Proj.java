...
public class CPCS391Proj {
    ...
    /*
    private void drawStarOfBackground() {
        glBegin(GL_LINE_LOOP);
        {
            glColor3d(0.5, 0.5, 0.5);
            glVertex3f(0.56f, 0.0f, 0f);
            glVertex3f(0.6f, -0.05f, 0f);
            glVertex3f(0.6f, -0.1f, 0f);
            glVertex3f(0.65f, -0.1f, 0f);
            glVertex3f(0.7f, -0.14f, 0f);
            glVertex3f(0.75f, -0.1f, 0f);
            glVertex3f(0.78f, -0.1f, 0f);
            glVertex3f(0.78f, -0.05f, 0f);
            //---------
            glVertex3f(0.825f, 0.0f, 0f);
            //---------
            glVertex3f(0.78f, 0.05f, 0f);
            glVertex3f(0.78f, 0.1f, 0f);
            glVertex3f(0.75f, 0.1f, 0f);
